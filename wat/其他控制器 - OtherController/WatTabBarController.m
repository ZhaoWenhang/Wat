...
- (void)viewDidLoad {
    ...
    // 添加子控制器
    [self setupChildVc:[[WatHomePageViewController alloc] init] title:@"发现" image:@"新闻资讯_nomal" selectedImage:@"新闻资讯_seleted"];
    [self setupChildVc:[[WatLearningViewController alloc] init] title:@"学习" image:@"大鱼课堂_nomal" selectedImage:@"大鱼课堂_seleted"];
    [self setupChildVc:[[yigoumaiViewController alloc] init] title:@"已购" image:@"学习记录_nomal" selectedImage:@"学习记录_seleted"];
    [self setupChildVc:[[WatMeViewController alloc] init] title:@"我" image:@"个人中心_nomal" selectedImage:@"个人中心_seleted"];
