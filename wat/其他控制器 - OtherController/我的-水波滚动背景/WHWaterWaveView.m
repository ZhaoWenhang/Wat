...
@implementation WHWaterWaveView {
...
- (CAShapeLayer *)bgLayer
{
    if (!_bgLayer) {
        ...
        _bgLayer.fillColor = rgba(213, 172, 116,0.5).CGColor;//214, 11, 14
    }
    return _bgLayer;
}
- (CAShapeLayer *)bgLayer2
{
    if (!_bgLayer2) {
        ...
        _bgLayer2.fillColor = rgba(213, 172, 116,0.5).CGColor;
    }
    return _bgLayer2;
}
- (CAShapeLayer *)bgLayer3
{
    if (!_bgLayer3) {
        ...
        _bgLayer3.fillColor = rgba(213, 172, 116,0.5).CGColor;
    }
    return _bgLayer3;
}
