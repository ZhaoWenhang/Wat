...
- (void)loadBaseView
{
    ...
    for (int i = 0; i < self.dataArry.count; i ++) {
        ...
        if (i == 0 && self.dataArry!=nil && self.dataArry.count > 1) {
            ...
            [imageView sd_setImageWithURL:self.dataArry[2] placeholderImage:[UIImage imageNamed:@"1234567890"]];
        }
        if (i == 1 && self.dataArry!=nil && self.dataArry.count > 0) {
            //imageView.backgroundColor = self.dataArry[0];//中间
            [imageView sd_setImageWithURL:self.dataArry[0] placeholderImage:[UIImage imageNamed:@"1234567890"]];
        }
        if (i == 2 && self.dataArry !=nil && self.dataArry.count > 1) {
            ...
            [imageView sd_setImageWithURL:self.dataArry[1] placeholderImage:[UIImage imageNamed:@"1234567890"]];
        }
