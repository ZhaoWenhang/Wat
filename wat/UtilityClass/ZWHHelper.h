...
#import <CommonCrypto/CommonDigest.h> //sha1 加密
...
- (void)popNavigationController:(UINavigationController *)selfNavigationController :(UINavigationController *)popToNav;//跳转到指定的控制器
//图片模糊处理
...
//时间格式转换
-(NSString *)getMMSSFromSS:(NSString *)totalTime; //传入秒,得到xx:xx:xx
-(NSString *)getSectionMMSSFromSS:(NSString *)totalTime;//传入秒,得到xx:xx
//手机号码 150****9208
