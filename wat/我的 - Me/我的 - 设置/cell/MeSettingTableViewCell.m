...
- (void)awakeFromNib {
    ...
    self.CellRightLab.hidden = YES;
    self.CellRightLab.frame =CGRectMake(100, 0, MyKScreenWidth - 100 - 10, 44);
    self.CellRightLab.textAlignment = NSTextAlignmentRight;
    self.CellRightLab.textColor = [UIColor blackColor];
    self.CellRightLab.font = commenAppFont(14);
