...
@interface VideoOneViewController ()<WKScriptMessageHandler,WKNavigationDelegate,WKUIDelegate>
...
- (void)MKWebViewre {
    ...
    //    }
    self.webView.frame = CGRectMake(0, 0, MyKScreenWidth, MyKScreenHeight - MyTopHeight - 44);
