...
#define CommonAppColor ColorWithRGB(255, 255, 255)//内参企业色 214, 1,14(内参红)
#define CommonAppNavBGColor ColorWithRGB(213, 172 ,116)
...
- (void)addBackNav
{
    ...
    [self.backBtn setImage:[UIImage imageNamed:@"zwy_nav_whiteBack_image"] forState:UIControlStateNormal];
...
- (void)addRightButtonsByArr:(NSArray *)arr;
{
    ...
    for (int i = 0; i<arr.count; i++) {
        ...
        //[rightBtn setImage:[UIImage imageNamed:@"zwy_nav_whiteBack_image"] forState:UIControlStateNormal];
...
- (UIView *)navBarView{
    if (!_navBarView) {
        ...
        _navBarView.backgroundColor = CommonAppNavBGColor;
        _navBarView.alpha = 1;
